...
class MemoryPool final {
    public:
        ...
        : mStore(element_size, {T(), true}) {
             ...
             == &(mStore[0]), "T object should be first member.");
        }
        ...
        T* allocate(Args... args) noexcept {
            ...
            ASSERT(block->is_free, 
                "Expected free Element at index:" 
        ...
        const auto elem_index = 
            ...
            ASSERT(elem_index >= 0 && static_cast<size_t>(elem_index) 
                    < mStore.size(), "Element does not belong to this pool.");
