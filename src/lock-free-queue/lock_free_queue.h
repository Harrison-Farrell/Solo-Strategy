...
/// \brief A lock-free, thread-safe queue for sharing information between threads.
/// This class implements a fixed-size circular buffer using atomic operations
/// to allow multiple threads to safely enqueue and dequeue elements without locks.
